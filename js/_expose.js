...
import { loadJSON, loadSampleData, onFileSelected, saveJSON, saveRecord, shareItinerary, openSaveModal, openLoadModal, openRestoreBackupModal } from './03-storage.js';
import { retryStopWeather } from './04-weather.js';
import { delStop, saveStop, setCurrentStop, captureCurrentLocation, _updateGeoHint, openInGoogleMaps, _onAddrPaste, pasteFromClipboard, confirmGeo } from './05-stop.js';
import { _commitTitle, _saveRouteDebounced, _saveTitleDebounced, _toggleTitleHelper, addDay, deleteCurrentDay, saveDayDate, switchDay } from './06-day.js';
import { checkTimeOrder, closeRideNote, dismissAppError, openRideNote, rideNavigate, toggleRideAction, _cfmOk, _cfmCancel } from './07-render.js';
import { _toggleTheme, _cycleFontSize, autoGrowNote, cancelEdit, cancelToRide, closeNoteModal, closeLogModal, openEditStop, openStopFormAdd, openNoteModal, openLogModal, setMode, tapStopInEdit, toggleRide, toggleMenu, openMenu, closeMenu } from './08-mode.js';
import { _cancelTouchDrag, onMouseDragStart, onTouchDragEnd, onTouchDragMove, onTouchDragStart } from './09-drag.js';
import { filterGasStation, filterHighwayDebounced, filterMichiDebounced, openGasStation, openHighway, openKaikatsu, openMichinoEki, selectGasStation, selectHighway, selectMichi } from './10-pickers.js';
...
Object.assign(window, {
  _cancelTouchDrag, _closeOverlay, _commitTitle, _dbgClear, _dbgCopy, _dbgDownload, _dbgSetEnabled, _saveRouteDebounced, _saveSplashSettings, _saveTitleDebounced, _toggleTitleHelper, _toggleTheme, _cycleFontSize, _updateEpisodePreview, addDay, autoGrowNote, cancelEdit, cancelToRide, checkTimeOrder, closeRideNote, delStop, deleteCurrentDay, dismissAppError, filterGasStation, filterHighwayDebounced, filterMichiDebounced, loadJSON, loadSampleData, openEditStop, openStopFormAdd, openNoteModal, closeNoteModal, openLogModal, closeLogModal, onFileSelected, onMouseDragStart, onTouchDragEnd, onTouchDragMove, onTouchDragStart, openGasStation, openHighway, openKaikatsu, openMichinoEki, openRideNote, openSplashSettings, retryStopWeather, confirmGeo, rideNavigate, saveDayDate, saveJSON, saveRecord, saveStop, selectGasStation, selectHighway, selectMichi, setCurrentStop, setMode, shareItinerary, switchDay, tapStopInEdit, toggleDetails, toggleFuelCheck, toggleGps, toggleRide, toggleRideAction, toggleMenu, openMenu, closeMenu, openSaveModal, openLoadModal, openRestoreBackupModal, captureCurrentLocation, _updateGeoHint, openInGoogleMaps, _onAddrPaste, pasteFromClipboard, _cfmOk, _cfmCancel,
});
